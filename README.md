...
- Conversions
- Revenue
- A/B test groups (Control vs Exposed)

  **Methodology**
  - Exploratory Data Analysis (EDA)
- Incrementality Testing (A/B test)
- ROI Analysis by channel
- Budget optimization insights

 ** Key Insights**
  - Google Ads delivered the highest ROI (4.47), making it the most efficient channel.
- Instagram generated the highest total revenue but required the highest spend.
- Facebook had the lowest ROI, indicating lower efficiency.

  **Business Recommendations**
  - Increase budget allocation to Google Ads to maximize efficiency.
- Optimize Instagram spend to improve profitability.
- Reevaluate or reduce spend on Facebook.
...
- Build predictive models for budget allocation
